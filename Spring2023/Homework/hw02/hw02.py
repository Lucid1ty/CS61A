...
If the value of start is less than 0, exit the function by returning None.
If the value of start is greater than or equal to stop, apply func1 on start and return the result.
If not, apply func1 on all the numbers from start (inclusive) up to stop (exclusive) and return the product.
    """
    ...
    def func2(stop):
        if start < 0:
            ...
            return product_using_accumulate(stop - start, func1)
    return func2
